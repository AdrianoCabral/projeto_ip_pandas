...
df.plot(kind='scatter',x='motor',y='marca',color='green')
df.plot(kind='bar',x='marca',y='kilometragem',color='blue')
df.plot(kind='bar',x='motor',y='kilometragem',color='yellow')
plt.show()
#plt.show()